...
namespace LocalTaste.Mvc
{
    ...
    {
        public ApplicationUserManager(IAuthenticationService store)
            : base(store)
        {
        }

        public static ApplicationUserManager Create(IdentityFactoryOptions<ApplicationUserManager> options, IAuthenticationService _authService)
        {
    ...
    public class ApplicationSignInManager : SignInManager<CustomIdentityUser, int>
    {
